...
namespace CinemaApp.Controllers
{
    public class SessionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Filmid,Hallid,Datetime,Price")] Session session)
        {
            ...
            ViewData["Filmid"] = new SelectList(_context.Films, "Id", "Id", session.Filmid);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Filmid,Hallid,Datetime,Price")] Session session)
        {
            if (id != session.Id)
            {
                return NotFound();
